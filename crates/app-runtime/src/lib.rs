...
fn plan_transition(
    ...
    match (previous.screen, screen, previous.prepared, prepared) {
        (
            ...
            T::new(A::BandReveal(direction_for_dashboard(&old, &new)), 3, 170)
        }
        (
            old_screen,
            new_screen,
        ...
        (
            ...
            PreparedScreen::Reader(old),
            PreparedScreen::Reader(new),
        ) if old.pause_modal.is_some() && new.pause_modal.is_none() => T::new(A::ModalHide, 3, 180),
        (
        ...
        {
            T::new(A::BandReveal(direction_for_settings(&old, &new)), 3, 170)
        }
        (
            Screen::Settings,
            Screen::Settings,
        ...
        {
            T::new(A::SettingsValuePulse, 3, 170)
        }
        (
            Screen::Settings,
            Screen::Settings,
